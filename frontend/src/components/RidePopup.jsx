...
const RidePopup = ({ setRidePopupPanelOpen, setConfirmRidePopupPanelOpen, rideRequest }) => {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="flex flex-col gap-3 items-center bg-yellow-500 p-5 rounded-xl">
        <img
        ...
        <h2 className="text-2xl">
          Aryan Tanna - <span className="bold-fonts">2.2 KM</span>
        </h2>
      </div>
      ...
      <div className="p-6">
        ...
        <button
          ...
          className="inline-block text-center bg-gray-400 text-gray-700 w-full py-2 text-[22px] rounded-[6px] mt-4"
        >
          Ignore
        </button>
      </div>
